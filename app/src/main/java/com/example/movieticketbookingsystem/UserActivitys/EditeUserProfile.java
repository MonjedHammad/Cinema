...
import com.example.movieticketbookingsystem.databinding.ActivityEditeUserProfileBinding;

public class EditeUserProfile extends AppCompatActivity {

    DbMovie dbMovie;
    ActivityEditeUserProfileBinding binding;
    SharedPreferences preferences;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEditeUserProfileBinding.inflate(getLayoutInflater());
